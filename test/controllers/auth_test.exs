defmodule Rumbl.AuthTests do
  ...
  test "authenticate user halts when no current user exists",
    %{conn: conn} do
  ...
  test "authenticate user continues when the current user exists",
    %{conn: conn} do
  ...
  test "call with no session sets current user assign to nil", %{conn: conn} do
